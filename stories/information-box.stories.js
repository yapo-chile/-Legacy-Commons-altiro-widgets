...
storiesOf('InfoBox', module)
  ...
  .add('4 elements ', () =>
    `<info-box
            ...
            content="Tu aviso tendrá habilitado el servicio de <strong>Pago y Despacho</strong> no tiene cobros asociados ya que éste lo asumirá el comprador. Si alguien está interesado en tu producto te notificaremos por email o en tu perfil de Yapo.cl para que aceptes la compra.">
